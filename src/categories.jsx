    ...
    <main className="shell">
      <section className="cat-page-head">
        ...
        <p className="lede" style={{ fontStyle: "normal", color: "var(--ink-2)", maxWidth: "100%", fontSize: "18px", lineHeight: 1.65 }}>
          No review is truly objective. Here, I've laid out what I weigh most and why it shapes the
          score to give a clearer picture of my scoring system. Personally, tastiness matters most;
          other categories are included for a fuller picture but I'm not especially particular about
          them. I'd recommend trying any restaurant or dish rated 7/10 or above.
        </p>
      </section>
